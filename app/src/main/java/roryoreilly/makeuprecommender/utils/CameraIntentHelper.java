...
//				String sdkVersion = android.os.Build.VERSION.RELEASE.toLowerCase(Locale.ENGLISH);
    ...
    /**
     * Sets the view whereby the image came from. This is to allow for activity swaping
     */
    ...
    private void onPhotoUriFound() {
        if (mCameraIntentHelperCallback != null) {
            mCameraIntentHelperCallback.onPhotoUriFound(dateCameraIntentStarted, photoUri, rotateXDegrees, view);
        }
    }
